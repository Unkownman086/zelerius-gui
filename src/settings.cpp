...
constexpr quint16 DEFAULT_LOCAL_RPC_PORT = 48082;
...
const constexpr char* DEFAULT_MINING_POOLS[] = { "pool.zelerius.org:3333", "pool.bitsumcash.org:4000" };
...
Settings::Settings()
{
    ...
    const QString jsonFile = getDefaultWorkDir().absoluteFilePath("zelerius-gui.config");
